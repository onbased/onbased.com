;(function () {
	...
	var showcasesAnimate = function() {
		var showcases = $('#fh5co-showcases');
		if ( showcases.length > 0 ) {	

			showcases.waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {

					var sec = showcases.find('.to-animate').length,
						sec = parseInt((sec * 100) + 200);

					setTimeout(function() {
						showcases.find('.to-animate').each(function( k ) {
							var el = $(this);
					...
					setTimeout(function() {
						showcases.find('.to-animate-2').each(function( k ) {
							var el = $(this);
